...
referencing, we want to make navigating the XPaXS documentation as easy as
possible.
...
* Please familiarize yourself with the Sphinx directives for `inline
  markup`_. XPaXS's documentation makes heavy use of cross-referencing and
...
* Function arguments and keywords should be referred to using the *emphasis*
  role. This will keep XPaXS's documentation consistant with Python's
  documentation::
...
* Sphinx does not support tables with column- or row-spanning cells for
  latex output. Such tables can not be used when documenting XPaXS.
...
* Use the *seealso* directive, for example::
    ...
    .. seealso::
       ...
       A bit about :ref:`referring-to-xpaxs-docs`:
          One more
...
* Keyword arguments should be described using a definition list.
  ...
  .. note::
     XPaXS makes extensive use of keyword arguments as pass-through
...
is generated (low and high res PNGs, a PDF).  XPaXS includes a
...
.. _referring-to-xpaxs-docs:

Referring to xpaxs documents
============================

In the documentation, you may want to include to a document in the XPaXS src,
e.g. a license file or an example.  When you include these files, include them
