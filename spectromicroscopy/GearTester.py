...
class Ui_MotorHead(object):
    def setupUi(self, MotorHead):
        ...
        self.minus.setGeometry(QtCore.QRect(1030,490,21,21))
        self.minus.setObjectName("minus")

        self.ClearLog = QtGui.QPushButton(self.Main)
        self.ClearLog.setGeometry(QtCore.QRect(410,590,75,23))
        self.ClearLog.setObjectName("ClearLog")

        self.ReStart = QtGui.QPushButton(self.Main)
        self.ReStart.setGeometry(QtCore.QRect(120,590,61,23))
        self.ReStart.setObjectName("ReStart")

        self.ResetVar = QtGui.QPushButton(self.Main)
        self.ResetVar.setGeometry(QtCore.QRect(190,590,61,23))
        self.ResetVar.setObjectName("ResetVar")

        self.Closer = QtGui.QPushButton(self.Main)
        self.Closer.setGeometry(QtCore.QRect(30,590,75,23))
        self.Closer.setObjectName("Closer")

        self.Positioner = QtGui.QSpinBox(self.Main)
        self.Positioner.setGeometry(QtCore.QRect(1020,460,46,23))
        self.Positioner.setObjectName("Positioner")

        self.label_motors = QtGui.QLabel(self.Main)
        self.label_motors.setGeometry(QtCore.QRect(1030,20,181,16))
        ...
        self.label_responses.setGeometry(QtCore.QRect(190,20,431,16))
    ...
    def retranslateUi(self, MotorHead):
        ...
        self.ResetVar.setText(QtGui.QApplication.translate("MotorHead", "Reset Var", None, QtGui.QApplication.UnicodeUTF8))
