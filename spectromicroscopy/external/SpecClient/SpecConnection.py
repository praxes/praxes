...
class SpecConnectionDispatcher(asyncore.dispatcher):
    ...
    def handle_error(self):
        ...
        logging.getLogger('SpecClient').exception('Closing connection to Spec')
        ...
        while offset < len(sbuffer):
            ...
            if self.message.isComplete():
                ...
                if self.message.cmd == SpecMessage.REPLY:                    
                    ...
                    self.registeredChannels[self.message.name].update(self.message.data, deleted=self.message.flags == SpecMessage.DELETED)
