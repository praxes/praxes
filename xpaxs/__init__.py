...
existing and very successful libraries such as PyMca, SpecClient, PyQt4, NumPy,
PyTables, and ParallelPython. It quickly became clear, however, that due to the
object-oriented nature of the Python language, with a little abstraction we were
poised to provide a framework for X-ray science in general.

XPaXS is therefore divided into several subpackages focusing on:

* Physical constants
* X-ray interactions with matter - dealing with atomic cross sections and basic
   interactions
* X-ray Absorption Sectroscopy
...
use PyQt4 for developing graphical user interfaces. PyQt4 is a python binding to
the modern and very actively developed Qt4 GUI toolkit, which is written in C++.
