...
void  macchess_initialize_camera()
{
  ...
  unsigned int gain, brightness, exposure;
...
dc1394_get_gain(handle, camera_nodes[0],&gain);
dc1394_get_brightness(handle, camera_nodes[0],&brightness);
dc1394_get_exposure(handle, camera_nodes[0],&exposure);
fprintf(stderr, "bright = %d, gain = %d exposure = %d\n",brightness,gain, exposure);

dc1394_set_gain(handle,camera_nodes[0],500);
dc1394_set_brightness(handle, camera_nodes[0],50);
dc1394_set_exposure(handle, camera_nodes[0],150);
...
fprintf(stderr, "bright = %d, gain = %d exposure = %d\n",brightness,gain, exposure);
fprintf(stderr, "note, these statements hang code!\n");
