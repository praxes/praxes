...
{
    return macchess_initialize_client((char*)DataSource::videoIP.ascii(), DataSource::videoPort );
}
...
void VideoRenderer :: run()
{
   ...
   while(true)
	...
	{	
	    ...
	    // REG!  experimental lines 
	    
     //       mutex.lock();
//	    macchess_send_crosshairs((int)(DataSource::pixPerMicron*DataSource :: crossX + DataSource::zcenX),
